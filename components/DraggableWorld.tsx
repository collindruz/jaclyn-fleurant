...
/** Fixed loose-print layout: mobile = vertical-ish stack, md+ = scattered overlap. */
const PRINTS: {
  m: { t: string; l: string; w: string };
  d: { t: string; l: string; w: string };
}[] = [
  { m: { t: "1%", l: "6%", w: "64%" }, d: { t: "2%", l: "6%", w: "26%" } },
  { m: { t: "12%", l: "10%", w: "60%" }, d: { t: "6%", l: "36%", w: "24%" } },
  { m: { t: "24%", l: "4%", w: "62%" }, d: { t: "4%", l: "64%", w: "23%" } },
  { m: { t: "35%", l: "12%", w: "58%" }, d: { t: "38%", l: "8%", w: "24%" } },
  { m: { t: "45%", l: "4%", w: "64%" }, d: { t: "36%", l: "44%", w: "21%" } },
  { m: { t: "56%", l: "9%", w: "60%" }, d: { t: "34%", l: "70%", w: "22%" } },
  { m: { t: "66%", l: "3%", w: "66%" }, d: { t: "64%", l: "6%", w: "22%" } },
  { m: { t: "75%", l: "11%", w: "56%" }, d: { t: "62%", l: "40%", w: "22%" } },
  { m: { t: "84%", l: "5%", w: "62%" }, d: { t: "64%", l: "68%", w: "20%" } },
  { m: { t: "92%", l: "7%", w: "58%" }, d: { t: "8%", l: "70%", w: "19%" } },
];
